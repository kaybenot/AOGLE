...
namespace AOGLE
{
    void Mesh::load_model(const Renderer& renderer) noexcept
    {
    ...
    bool Mesh::import_from_file(const Renderer& renderer, const std::string& file) noexcept
    {
    ...
    void Mesh::draw(const Renderer& renderer) noexcept
    {
        switch (renderer.Type)
        {
        case RendererType::OpenGL:
